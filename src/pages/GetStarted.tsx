...
import { ArrowLeft, Zap, CheckCircle2, AlertCircle, Download } from "lucide-react";
...
const GetStarted = () => {
  ...
  const completeScan = (material: MaterialType) => {
    setTimeout(() => {
      ...
      const basePurity = 94 + Math.random() * 5; // 94-99%
      ...
      toast.success("Scan completed successfully!", {
        description: `${material.charAt(0).toUpperCase() + material.slice(1)} purity: ${purity}%`,
      });
    }, 500);
  };
        ...
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Select a material to simulate Raman spectroscopy scanning and see instant ML-powered purity detection.
            </p>
          </div>
